...
function EditSheet() {
  ...
  if (ownerId) {
    ...
    navLink = (
      <div className="list">
        <a
          href="https://us-east-21winqvkkq.auth.us-east-2.amazoncognito.com/login?client_id=5a0k6f5kn0l6hvo04hm7sjec66&response_type=code&scope=email+openid+phone&redirect_uri=https%3A%2F%2Fnotonmybingosheet.onrender.com%2Fcallback"
        >
          Login
        </a>
      </div>
